...
document.addEventListener("DOMContentLoaded", function() {
    ...
    moveToTrashBtn.addEventListener('click', async function() {
        ...
        // Confirm with the user before moving items to trash
        const confirmationMessage = `Are you sure you want to move these files/folders to trash?`;
        if (!confirm(confirmationMessage)) {
            return; // Stop if the user cancels
        }

        // Send move-to-trash requests for all selected items
        ...
        try {
            // Await all promises from the move-to-trash requests
            ...
            // Reload the page or update UI to reflect changes
            location.reload();
        } catch (error) {
